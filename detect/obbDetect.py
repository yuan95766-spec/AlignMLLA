...
def detecttwoStream():
    img = cv2.imread("/home/yuan/my_project/TwoStream_Yolov8-main/TwoStream_Yolov8-main/ultralytics/datasets/OBBCrop/images/test/03003.jpg")
    imgr=img
    irimg = cv2.imread("/home/yuan/my_project/TwoStream_Yolov8-main/TwoStream_Yolov8-main/ultralytics/datasets/OBBCrop/image/test/03003.jpg")
    ...
    model = load_model("/home/yuan/my_project/TwoStream_Yolov8-main/TwoStream_Yolov8-main/runs/detect/best.pt", device)
